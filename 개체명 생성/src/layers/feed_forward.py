...
class FeedForward(tf.keras.layers.Layer):
    def __init__(self, hidden_size, filter_size, dropout_rate=0.1, activation=tf.nn.selu, trainable=True):
        ...
        self.dense_layer = Conv1d(self.hidden_size, self.filter_size, trainable=self.trainable)
        self.output_dense_layer = Conv1d(self.filter_size, self.hidden_size, trainable=self.trainable)
