...
from src.layers.feed_forward import Conv1d


class MultiHeadAttention(tf.keras.layers.Layer):
    def __init__(self, d_model, num_heads, att_dropout=0.1, residual_dropout=0.1, scale=True, trainable=True):
        ...
        self.c_attn = Conv1d(self.d_model, self.d_model * 3, trainable=self.trainable)
        self.c_proj = Conv1d(self.d_model, self.d_model, trainable=self.trainable)
