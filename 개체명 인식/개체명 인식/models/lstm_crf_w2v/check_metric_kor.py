...
def compute_metrics(true_named_entities, pred_named_entities):
    ...
    target_tags_no_schema = ['DT', 'LC', 'OG', 'PS', 'TI']
...
def compute_f1(test_sents_labels, y_pred):
    ...
    evaluation_agg_entities_type = {e: deepcopy(results) for e in ['DT', 'LC', 'OG', 'PS', 'TI']}
...
if __name__=="__main__":
    # with open(r'label_test.txt', 'r',encoding="utf8") as fb:
    # with open(r'results.txt', 'r',encoding="utf8") as fb:
    with open(r'result_etri_final_postag/score/testb.preds.txt', 'r', encoding="utf8") as fb:
    # with open(r'testb.preds.txt', 'r', encoding="utf8") as fb:
        print("computing_F1")
        pred = []
        answer = []
