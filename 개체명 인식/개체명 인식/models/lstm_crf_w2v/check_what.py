...
#이건 영어
# with open("./label_test.txt",'r',encoding="utf8") as rf, open("results.txt",'w',encoding="utf8") as wf:
with open("./result_kmou_postag_bit2/score/testb.preds.txt",'r',encoding="utf8") as rf, open("results.txt",'w',encoding="utf8") as wf:
    for line in rf.readlines():
        line= line.strip()
        if len(line) == 0:
            print(file=wf)
