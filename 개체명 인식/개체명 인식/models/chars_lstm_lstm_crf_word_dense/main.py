...
handlers = [
    logging.FileHandler('results_test/main.log'),
...
if __name__ == '__main__':
    ...
    with Path('results_test/params.json').open('w') as f:
    ...
    estimator = tf.estimator.Estimator(model_fn, 'results_test/model', cfg, params)
    ...
    def write_predictions(name):
        Path('results_test/score').mkdir(parents=True, exist_ok=True)
        with Path('results_test/score/{}.preds.txt'.format(name)).open('wb') as f:
