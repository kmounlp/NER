...
# Logging
Path('results_tag').mkdir(exist_ok=True)
tf.logging.set_verbosity(logging.INFO)
handlers = [
    logging.FileHandler('results_tag/main.log'),
...
if __name__ == '__main__':
    ...
    with Path('results_tag/params.json').open('w') as f:
    ...
    estimator = tf.estimator.Estimator(model_fn, 'results_tag/model', cfg, params)
    ...
    def write_predictions(name):
        Path('results_tag/score').mkdir(parents=True, exist_ok=True)
        with Path('results_tag/score/{}.preds.txt'.format(name)).open('wb') as f:
