"""W2V Embeddings + chars bi-LSTM + bi-LSTM + CRF"""
...
DATADIR = '../../data/example/NER_ETRI_fine'
...
def model_fn(features, labels, mode, params):
    ...
    W2V = np.load(params['W2V'])['embeddings']  # np.array
    variable = np.vstack([W2V, [[0.] * params['dim']]])
...
if __name__ == '__main__':
    ...
    def write_predictions(name):
        ...
        with Path('results_new_fine'
                  '/score/{}.preds.txt'.format(name)).open('wb') as f:
