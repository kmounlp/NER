...
def compute_metrics(true_named_entities, pred_named_entities):
    ...
    target_tags_no_schema = ['LOC', 'PER', 'ORG', 'MISC']
...
if __name__=="__main__":
    # with open(r'results_eng/score/testb.preds.txt', 'r') as fb:
    # with open(r'results.txt', 'r') as fb:
    with open(r'label_test.txt', 'r') as fb:
        print("computing_F1")
        pred = []
        answer = []
