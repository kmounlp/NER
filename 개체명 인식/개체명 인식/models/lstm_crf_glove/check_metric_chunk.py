...
def compute_metrics(true_named_entities, pred_named_entities):
    ...
    target_tags_no_schema = ['AX', 'CX', 'ECX', 'EFX', 'EPX','ETX','IX','JCX','JKX','JMX','JUX','JVX','MX','NAX','NX','PUX','PX','SYX']
...
def compute_f1(test_sents_labels, y_pred):
    ...
    evaluation_agg_entities_type = {e: deepcopy(results) for e in  ['AX', 'CX', 'ECX', 'EFX', 'EPX','ETX','IX','JCX','JKX','JMX','JUX','JVX','MX','NAX','NX','PUX','PX','SYX']}
...
if __name__=="__main__":
    ...
    with open(r'./results_chunk/score/testb.preds.txt', 'r', encoding="utf8") as fb:
        print("computing_F1")
        pred = []
        answer = []
